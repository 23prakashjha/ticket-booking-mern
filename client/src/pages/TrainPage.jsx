  ...
  return (
    <div className="min-h-screen bg-slate-50">
      ...
      <div className="relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-blue-900">
        ...
        <div className="absolute top-10 left-10 w-64 h-64 bg-blue-400/20 rounded-full blur-3xl animate-float-slow" />
        <div className="absolute bottom-10 right-10 w-48 h-48 bg-blue-300/15 rounded-full blur-3xl animate-float-slower" />
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 pt-12 sm:pt-16 pb-8 sm:pb-10">
          <div className="flex flex-col items-center text-center">
            ...
            <p className="text-blue-100 text-base sm:text-lg max-w-xl animate-fade-in-up">
              Search and book train tickets across India with ease
            </p>
          </div>
        </div>
      </div>
        ...
        <form onSubmit={handleSearch} className="glass-card p-5 sm:p-6 shadow-glow border border-white/30 animate-fade-in-up">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-12 gap-4 items-end">
            <div className="lg:col-span-4 input-icon">
              ...
              <input name="source" type="text" defaultValue={source} placeholder="From Station" className="input-field" />
            </div>
            <div className="lg:col-span-4 input-icon">
              <svg className="icon w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              ...
              <input name="destination" type="text" defaultValue={destination} placeholder="To Station" className="input-field" />
            </div>
            ...
            <div className="lg:col-span-2">
              <button type="submit" className="btn-primary w-full py-3 bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 shadow-lg shadow-blue-500/30">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pb-12">
        {loading ? (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" role="status" aria-label="Loading trains">
          ...
          <div className="card p-12 sm:p-16 text-center animate-fade-in-up">
            <div className="w-24 h-24 sm:w-32 sm:h-32 rounded-full bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center mx-auto mb-6">
              <span className="text-5xl sm:text-6xl opacity-70">🚂</span>
            </div>
            <h2 className="text-2xl font-bold text-slate-900 mb-3">No trains found</h2>
            <p className="text-slate-500 max-w-md mx-auto mb-4">
              We couldn&apos;t find any trains matching your search. Try adjusting your source, destination, or travel date.
            </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className="col-span-full flex items-center justify-between mb-2 animate-fade-in">
              <p className="text-slate-500 text-sm">
                <span className="font-semibold text-slate-800">{trains.length}</span> train{trains.length !== 1 ? 's' : ''} found
              </p>
            </div>
            {trains.map((t, i) => (
              <div key={t._id} className="animate-fade-in-up" style={{ animationDelay: `${i * 80}ms` }}>
                <ResultCard type="train" item={t} to={`/trains/${t._id}`} formatDate={formatDate}>
                  <span className="text-blue-600 font-bold text-lg">₹{t.pricePerSeat}</span>
